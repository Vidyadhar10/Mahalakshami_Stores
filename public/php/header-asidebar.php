<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                <?php echo $ActiveSupportBar; ?>
                <a class="inline-flex items-center w-full text-sm font-semibold <?php echo $SupportActiveTextColor; ?> transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="./support.php">
                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z">
                        </path>
                    </svg>
                    <span class="ml-4" data-translate="MenubarSupportItem">Support</span>
                </a>
            </li>
            <!-- <hr>
        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold <?php echo $SupportActiveTextColor; ?> transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="./support.php">
                    ...
                    <span class="ml-4" data-translate="MenubarRequestItem">Support</span>
                </a>
            </li>
            <li class="relative px-6 py-3 adminView">
                <?php echo $ActiveSettingsBar; ?>
